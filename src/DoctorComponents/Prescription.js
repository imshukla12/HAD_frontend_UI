...
const Prescription = () => {
  ...
  const medicineString = inputFeilds.map((item) => {
      ...
      <form className="items-center justify-evenly">
          ...
          return (
            <div key={index}>
              <div className="grid grid-cols-5 gap-4">
                <div
                  className="col-span-4 grid md:grid-cols-3 md:gap-6"
                  style={{
                ...
                >
                  ...
                  <div
                    className="relative z-0 w-full mb-6 group space-x-2"
        ...
        <div className=" flex flex-col border-2 rounded-lg border-blue-300 items-center justify-center p-4">
          <div className="flex flex-row items-center space-x-2 px-8">
            <p className="py-2 text-sm text-gray-900 font-serif">
