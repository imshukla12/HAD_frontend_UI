          ...
          <form className="w-4/5 p-8 items-center justify-evenly h-4/5 font-serif border-2 border-gray-200 rounded-lg">
            ...
            <div className="grid md:grid-cols-3 md:gap-6 align-center justify-center">
              <div className="relative z-0 w-full mb-6 group">
                ...
                <select
                  id="Title"
                  className=" text-zinc-500 text-sm rounded-lg border-2 border-gray-200 focus:ring-blue-500 focus:border-blue-500 block w-full p-2 bg-white"
                  placeholder="Title"
                  value={title}
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input
                  ...
                  id="FirstName"
                  autoComplete="false"
                  className="block py-2.5 px-0 w-full text-sm text-zinc-500 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                  value={firstName}
                ...
                <label
                  for="FirstName"
                  className="peer-focus:font-medium absolute text-sm text-zinc-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Firstname
                </label>
              </div>
            ...
            <div className="grid md:grid-cols-2 md:gap-6 align-center justify-center">
              <div className="relative z-0 w-full mb-6 group items-center justify-center">
                ...
                <select
                  id="Gender"
                  className="border-2 border-gray-200 text-zinc-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 bg-white"
                  value={gender}
            ...
            <div className="grid md:grid-cols-2 md:gap-6 align-center justify-center">
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input
                  ...
                  name="floating_phone"
                  id="floating_phone"
                  className="block py-2.5 px-0 w-full text-sm text-zinc-400 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                  value={phoneNo}
            ...
            <div className="grid md:grid-cols-3 md:gap-6 align-center justify-center">
              ...
              <div className="relative z-0 w-full mb-6 group items-center justify-center">
                ...
                <select
                  ...
                  className="border-2 border-gray-200 text-zinc-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 bg-white"
                  value={drDept}
                  onChange={(e) => setDrDept(e.target.value)}
                  disabled
                >
