...
const PatientRegistration = () => {
  ...
  const addPatient = async () => {
    ...
    await axios
      .post(`${process.env.REACT_APP_BACKEND_URL}/patient/addPatient`, data)
      .then((response) => {
      ...
      <div className="flex items-center justify-center h-screen mt-4">
        <div className="w-full flex items-center justify-center">
          <form
            ...
            className="w-4/5 p-8 items-center justify-evenly h-4/5 font-serif border-2 border-gray-200 rounded-lg"
          >
            ...
            <div className="grid md:grid-cols-3 md:gap-6 align-center justify-center">
              <div className="relative z-0 w-full mb-6 group">
                ...
                <select
                  id="Title"
                  className=" text-gray-900 text-sm rounded-lg border-2 border-gray-200 focus:ring-blue-500 focus:border-blue-500 block w-full p-2 bg-transparent"
                  placeholder="Title"
                  value={title}
            ...
            <div className="grid md:grid-cols-2 md:gap-6 align-center justify-center">
              <div className="relative z-0 w-full mb-6 group items-center justify-center">
                ...
                <select
                  id="Gender"
                  className="border-2 border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 bg-transparent"
                  value={gender}
            ...
            <button
              type="submit"
              className="text-white bg-green-400 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-800 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 transform transition duration-300 hover:scale-110"
            >
              Register
            </button>
          </form>
